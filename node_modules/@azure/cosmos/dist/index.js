...
class GlobalEndpointManager {
    ...
    async resolveServiceEndpoint(diagnosticNode, resourceType, operationType, startServiceEndpointIndex = 0 // Represents the starting index for selecting servers.
    ) {
